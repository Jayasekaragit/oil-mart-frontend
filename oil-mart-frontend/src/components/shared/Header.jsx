      ...
      <Popover className="relative px-3">
          ...
          <PopoverButton className=" p-3 rounded-sm inline-flex text-gray-700 hover:text-opacity-100 focus:outline-none">
            <span>Pasindu Jayasekara</span>
              <div className="h-10 rounded-full bg-sky-500 bg-cover bg-no-repeat bg-center" >
            ...
            >
              <div className="p-3">
                <a className="block rounded-lg py-2 px-3 transition hover:bg-white/5" href="#">
                  <p className="font-semibold text-white"><Link className="text-white hover:text-black" to={"/products"}>SignOut</Link></p>
